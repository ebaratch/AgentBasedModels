package Models.FusionModelEtienne.FusionModel3DHeterogeneity;
...
public class FusionModel {
    ...
    public static void main(String[] args) {
        ...
        try {
            File file = new File("/Users/baratcEA/work/Moffitt/Phoenix/Fusion/ResultsSpatial/Heterogeneity3D/Shanon.txt");
            ...
            for (int i = 0; i < TIMESTEPS; i++) {
                ...
                DrawCells(vis, d, "/Users/baratcEA/work/Moffitt/Phoenix/Fusion/ResultsSpatial/Heterogeneity3D/", i);
    ...
    static void DrawCells(Vis3DOpenGL vis,Dish d,String path,int i){
        ...
        //for (Cell c:d) {
            //color "nucleus"
        //    vis.CelSphere(c.Xpt(),c.Ypt(),c.Zpt(),c.radius/2.0, Dish.BLUE);
        //}
        vis.Show();
        if (i==TIMESTEPS-1){
